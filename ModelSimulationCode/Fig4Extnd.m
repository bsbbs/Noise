...
V1mean = 88;
V2mean = 83;
eps1 = 4.5;%10; % early noise for V1
eps2 = 4.5;%10; % early noise for V2
...
etavec = [1, 1.4286]; % etavec([2,5]); % .9571, 1.4286
K = 75;
...
%             end
    ...
    for ti = 1:numel(etavec)
        ...
        for i = 1:numel(eps3vec)
            %         if i == 1
            %             eps = 4;
            %             startColor = '#00FF80'; % Light-blue
            %             endColor = '#0000FF';  % Blue
            %             %yrng = [68.3, 74.5]+1;
            %         elseif i == 2
            %             eps = 9;
            %             startColor = '#FF0000'; % Red
            %             endColor = '#FFBF00'; % Pink
            %             %yrng = [67.1, 72.45]+1;
            %         end
