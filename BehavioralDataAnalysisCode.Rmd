...
summary(lmtest3)
lmtest3 <- glmer(choice ~ VD + VD:V3:varbid3 + (0 + VD|subID), family = "binomial", data = grpdcsn[grpdcsn$TimePressure == 'Low' & (grpdcsn$choice == 1 | grpdcsn$choice == 0),])
summary(lmtest3)
lmtest3 <- glmer(choice ~ V3scld + V3scld:varbid3scld + (0 + VDscld|subID), family = "binomial", data = grpdcsn[grpdcsn$TimePressure == 'Low' & (grpdcsn$choice == 1 | grpdcsn$choice == 0),])
summary(lmtest3)
lmtest3 <- glmer(choice ~ V3scld + V3scld:varbid3scld + (0 + VDscld|subID), family = "binomial", data = grpdcsn[grpdcsn$TimePressure == 'High' & (grpdcsn$choice == 1 | grpdcsn$choice == 0),])
summary(lmtest3)
lmtest3 <- glmer(choice ~ V3 + V3:varbid3 + (0 + VD|subID), family = "binomial", data = grpdcsn[grpdcsn$TimePressure == 'Low' & (grpdcsn$choice == 1 | grpdcsn$choice == 0),])
summary(lmtest3)


lmtest4 <- glmer(choice ~ VD + VD:varbid3 + VD:V3:Vagueness:TimePressure + VD:TimePressure + (VD|subID), family = "binomial", data = grpdcsn[(grpdcsn$choice == 1 | grpdcsn$choice == 0) & grpdcsn$V3scld >= .2 & grpdcsn$V3scld <= .8,])
summary(lmtest4)


# Test independent conditions first
summary(lmtest <- glmer(choice ~ V3scld*varbid3scld + (0 + VDscld|subID), family = "binomial", data = grpdcsn[grpdcsn$TimePressure == 'High' & grpdcsn$Vagueness == 'Vague' & (grpdcsn$choice == 1 | grpdcsn$choice == 0),]))
summary(lmtest <- glmer(choice ~ VDscld + V3scld*varbid3scld + (0 + VDscld|subID), family = "binomial", data = grpdcsn[grpdcsn$TimePressure == 'High' & grpdcsn$Vagueness == 'Vague' & (grpdcsn$choice == 1 | grpdcsn$choice == 0),]))
summary(lmtest <- glmer(choice ~ VDscld+ VDscld:V3scld + (1|subID), family = "binomial", data = grpdcsn[grpdcsn$TimePressure == 'Low' & grpdcsn$Vagueness == 'Vague' & (grpdcsn$choice == 1 | grpdcsn$choice == 0),]))

# whether a linear regression able to capture the impact from early-noise variance 
summary(lmtest <- glmer(choice ~ V1 + V2 + varbid1 + varbid2 + (1|subID), family = "binomial", data = grpdcsn[(grpdcsn$choice == 1 | grpdcsn$choice == 0),]))
summary(lmtest <- glmer(choice ~ V1 + V2 + V3 + varbid1 + varbid2 + (1|subID), family = "binomial", data = grpdcsn[(grpdcsn$choice == 1 | grpdcsn$choice == 0),]))
summary(lmtest <- glmer(choice ~ V1 + V2 + V3 + varbid1 + varbid2 + varbid3 + (1|subID), family = "binomial", data = grpdcsn[(grpdcsn$choice == 1 | grpdcsn$choice == 0),]))
summary(lmtest <- glmer(choice ~ V1 + V2 + varbid1 + varbid2 + varbid3 + (1|subID), family = "binomial", data = grpdcsn[(grpdcsn$choice == 1 | grpdcsn$choice == 0),]))
